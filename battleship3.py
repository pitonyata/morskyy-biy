...
class MainMenu:
    ...
    def setup_menu(self):
        ...
        buttons_frame = tk.Frame(main_frame, bg='#1a2a2e')
    ...
    def exit_game(self):
        ...
        buttons_container = tk.Frame(main_frame, bg='#1a2a2e')
    ...
    def show_about(self):
        ...
        about_window.configure(bg='#1a2a2e')
        ...
        main_frame = tk.Frame(about_window, bg='#1a2a2e', padx=30, pady=30)
        main_frame.pack(fill=tk.BOTH, expand=True)
...
class BattleshipGame:
    ...
    def setup_ui(self):
        ...
        # Заголовок гри
        title_frame = tk.Frame(self.root, bg='#1a2a2e')
        ...
        boards_frame = tk.Frame(self.root, bg='#1a2a2e')
        ...
        # Поле гравця (ліворуч)
        player_container = tk.Frame(boards_frame, bg='#1a2a2e')
        ...
        computer_container = tk.Frame(boards_frame, bg='#1a2a2e')
        ...
        control_frame = tk.Frame(self.root, bg='#1a2a2e')
        ...
        # Панель рахунку
        score_frame = tk.Frame(self.root, bg='#1a2a2e')
